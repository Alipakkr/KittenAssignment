...
const ConnectingDB = async () => {
  try {
    ...
    const connection = await mongoose.connect(URL, {
      useNewUrlParser: true,          // MongoDB connection options: Use new URL parser.
      useUnifiedTopology: true,       // MongoDB connection options: Use new Server Discover and Monitoring engine.
    });
